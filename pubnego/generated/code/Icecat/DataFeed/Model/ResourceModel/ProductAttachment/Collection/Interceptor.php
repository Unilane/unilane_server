<?php
namespace Icecat\DataFeed\Model\ResourceModel\ProductAttachment\Collection;

/**
 * Interceptor class for @see \Icecat\DataFeed\Model\ResourceModel\ProductAttachment\Collection
 */
class Interceptor extends \Icecat\DataFeed\Model\ResourceModel\ProductAttachment\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addEntityFilter($entityId, $storeId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addEntityFilter', func_get_args(), $pluginInfo) : parent::addEntityFilter($entityId, $storeId);
    }
