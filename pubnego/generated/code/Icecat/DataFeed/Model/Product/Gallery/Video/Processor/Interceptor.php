...
class Interceptor extends \Icecat\DataFeed\Model\Product\Gallery\Video\Processor implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function addVideo($productId, array $videoData, $storeId, $mediaAttribute = null, $move = false, $exclude = true, $mediaTmpDiretory = null)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addVideo');
        return $pluginInfo ? $this->___callPlugins('addVideo', func_get_args(), $pluginInfo) : parent::addVideo($productId, $videoData, $storeId, $mediaAttribute, $move, $exclude, $mediaTmpDiretory);
    }
