<?php
namespace Icecat\DataFeed\Console\Command\QueueRunner;

/**
 * Interceptor class for @see \Icecat\DataFeed\Console\Command\QueueRunner
 */
class Interceptor extends \Icecat\DataFeed\Console\Command\QueueRunner implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Icecat\DataFeed\Helper\Data $data, \Magento\Framework\Message\ManagerInterface $messageManager, \Icecat\DataFeed\Model\Queue $queue, \Magento\Framework\App\State $state, \Icecat\DataFeed\Model\Scheduler $scheduler, \Magento\Framework\Event\Observer\Cron $cron, ?string $name = null)
    {
        $this->___init();
        parent::__construct($data, $messageManager, $queue, $state, $scheduler, $cron, $name);
    }
