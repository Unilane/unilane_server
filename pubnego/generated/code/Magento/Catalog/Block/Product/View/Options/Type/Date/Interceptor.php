...
class Interceptor extends \Magento\Catalog\Block\Product\View\Options\Type\Date implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useCalendar');
        return $pluginInfo ? $this->___callPlugins('useCalendar', func_get_args(), $pluginInfo) : parent::useCalendar();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDateHtml');
        return $pluginInfo ? $this->___callPlugins('getDateHtml', func_get_args(), $pluginInfo) : parent::getDateHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCalendarDateHtml');
        return $pluginInfo ? $this->___callPlugins('getCalendarDateHtml', func_get_args(), $pluginInfo) : parent::getCalendarDateHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDropDownsDateHtml');
        return $pluginInfo ? $this->___callPlugins('getDropDownsDateHtml', func_get_args(), $pluginInfo) : parent::getDropDownsDateHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTimeHtml');
        return $pluginInfo ? $this->___callPlugins('getTimeHtml', func_get_args(), $pluginInfo) : parent::getTimeHtml();
    }
    ...
    public function getPrice($price, $includingTax = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getPrice', func_get_args(), $pluginInfo) : parent::getPrice($price, $includingTax);
    }
