...
class Interceptor extends \Magento\Catalog\Block\Product\View\Options\Type\File implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFileInfo');
        return $pluginInfo ? $this->___callPlugins('getFileInfo', func_get_args(), $pluginInfo) : parent::getFileInfo();
    }
