...
class Interceptor extends \Magento\Variable\Block\System\Variable\Edit\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVariable');
        return $pluginInfo ? $this->___callPlugins('getVariable', func_get_args(), $pluginInfo) : parent::getVariable();
    }
