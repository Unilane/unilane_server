...
class Interceptor extends \Mageplaza\LayeredNavigation\Block\Adminhtml\Product\Attribute\Edit\Tab\Layer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareAttributeData');
        return $pluginInfo ? $this->___callPlugins('prepareAttributeData', func_get_args(), $pluginInfo) : parent::prepareAttributeData($attribute);
    }
