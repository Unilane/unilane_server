...
class Interceptor extends \Mageplaza\SocialLogin\Block\Popup\Social implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBtnKey');
        return $pluginInfo ? $this->___callPlugins('getBtnKey', func_get_args(), $pluginInfo) : parent::getBtnKey($key);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSocialButtonsConfig');
        return $pluginInfo ? $this->___callPlugins('getSocialButtonsConfig', func_get_args(), $pluginInfo) : parent::getSocialButtonsConfig();
    }
    ...
    public function canShow($position = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('canShow', func_get_args(), $pluginInfo) : parent::canShow($position);
    }
    ...
    public function getLoginUrl($socialKey, $params = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getLoginUrl', func_get_args(), $pluginInfo) : parent::getLoginUrl($socialKey, $params);
    }
